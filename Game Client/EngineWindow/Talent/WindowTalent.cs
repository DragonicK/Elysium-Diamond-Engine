...
namespace Elysium_Diamond.EngineWindow {
    public static class WindowTalent {
        ...
        public static void Initialize() {
            ...
            main_background.Texture = EngineTexture.TextureFromFile($"{AppData}/Elysium/Data/Graphics/talent_back.png", 800, 416);
            ...
            slot_background.Texture = EngineTexture.TextureFromFile($"{AppData}/Elysium/Data/Graphics/talent_slot_back.png", 192, 288);
        ...
        private static void OpenTalents() {
            string AppData = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData);
            if (!File.Exists($"{AppData}/Elysium/Data/Talent.bin")) {
                return;
            }

            using (FileStream file = new FileStream($"{AppData}/Elysium/Data/Talent.bin", FileMode.Open, FileAccess.Read)) {
